...
/** ***********************************************************************************************/
WidgetBoxModel::ConfigWidget::ConfigWidget(WidgetBoxModel::Frontend *frontend, QWidget *parent)
