...
This way nobody has to reject PR's, nobodies PR's will get rejected and there will not be multiple developers working on the same issue.
...
- Say thanks by donating some bucks via [paypal](https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=W74BQPKPGNSNC),  [flattr](https://flattr.com/submit/auto?user_id=manuelschneid3r&url=https%3A%2F%2Fgithub.com%2FManuelSchneid3r%2Falbert) or [patreon](https://www.patreon.com/albertlauncher).
